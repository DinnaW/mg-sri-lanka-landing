 ...
 *
 * The 41 MB GLB is NOT requested here. HomeView does not mount
 * MgCinematic3DStage until MgPreloader emits "finished", so the
 * heavy model and its three cinematic videos still start only
 * after the preloader has completely left the screen.
 *
